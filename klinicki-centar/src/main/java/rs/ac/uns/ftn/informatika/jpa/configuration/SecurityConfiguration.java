...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/listaSvihTerminaPacijent2").permitAll()
		.antMatchers("/naListuLekaraSaZakazivanjaPregleda2").permitAll()
	    ...
	    .antMatchers("/odustaniOdOcenjivanjaLekaraPregled").permitAll()
	    .antMatchers("/odustaniOdOcenjivanjaKlinikePregled").permitAll()
	    .antMatchers("/odustaniOdOcenjivanjaKlinikePregled2").permitAll()
	    .antMatchers("/odustaniOdOcenjivanjaLekaraPregled3").permitAll()
