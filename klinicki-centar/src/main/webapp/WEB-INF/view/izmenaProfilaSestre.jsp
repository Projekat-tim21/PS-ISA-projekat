...
<link href="http://localhost:8081/src/main/webapp/static/css/bootstrap.min.css" rel="stylesheet" type="css">
<link href="./static/css/style.css" rel="stylesheet" type="css">
<link href="./static/css/theme.css" rel="stylesheet" type="css">
...
<script type="text/javascript">
		...
		function checkredirect() {
			window.location = 'http://localhost:8081/sacuvajIzmeneProfila?id='
					+ napokooon;
