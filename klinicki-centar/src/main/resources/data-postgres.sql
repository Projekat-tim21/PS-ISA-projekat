...
insert into termini(lekar_id, termin,sala, cena, popust, lekarime, lekarprezime, tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz) values (3, '2019-12-04T05:42', '2B', 1000, 10 , 'Sara', 'Saric','dermatologija','false',3,'false','true');
...
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz) values (3, '2019-11-04T05:30', '3C', 1800, 0, 'Mara', 'Maric', 'url', 'false',3, 'false', 'true');
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz) values (16, '2020-01-01T05:30', '3C', 1800, 0, 'Jova', 'Lekic', 'url', 'false',3, 'false', 'true');
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz) values (16, '2019-01-14T05:30', '3C', 1800, 0, 'Mara', 'Maric', 'url', 'false',3, 'false', 'true');
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz) values (16, '2020-01-11T05:30', '3C', 1800, 0, 'Jova', 'Lekic', 'url', 'false',3, 'false', 'true');
