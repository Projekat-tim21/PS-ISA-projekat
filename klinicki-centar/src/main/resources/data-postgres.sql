...
insert into korisnik3 ( adresa, drzava, email, grad, ime, jed_br_osig, password, prezime,telefon, username,active,role,klinika_id,login ) values ('Anica Dobra 1', 'Srbija', 'ana@gmail.com',  'Novi Sad', 'Ana', '8585608888', 'ana', 'Ana', '064999858', 'ana','TRUE','ADMIN_KLINIKE',6,true);
...
insert into termini(lekar_id, termin,sala, cena, popust, lekarime, lekarprezime, tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (3, '2019-12-04T05:42', '2B', 1000, 10 , 'Sara', 'Saric','dermatologija','false',0,'false','true','false',21);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime, tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (2, '2019-10-04T06:50', '1A', 2000, 15, 'Mara', 'Maric', 'url','false',0,'false', 'true','false',20);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (1, '2019-12-05T06:50', '2B', 1500, 20, 'Zoran', 'Zoric', 'ocno', 'false',0, 'false', 'true','false',19);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz,poslatnaobradu,korisnik_id) values (2, '2019-11-04T05:30', '3C', 1800, 0, 'Mara', 'Maric', 'url', 'false',0, 'false', 'true','false',20);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (4, '2019-12-05T06:50', '2B', 1500, 20, 'Kata', 'Katic', 'ocno', 'false',0, 'false', 'true','false',22);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz,poslatnaobradu,korisnik_id) values (2, '2019-11-04T05:30', '3C', 1800, 0, 'Mara', 'Maric', 'url', 'false',0, 'false', 'true','false',20);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (6, '2019-12-05T06:50', '2B', 1500, 20, 'Pedja', 'Matic', 'dermatologija', 'false',0, 'false', 'true','false',24);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz,poslatnaobradu,korisnik_id) values (4, '2019-11-04T05:30', '3C', 1800, 0, 'Kata', 'Katic', 'ocno', 'false',0, 'false', 'true','false',22);


/*unapred definisani*/

insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz,poslatnaobradu,korisnik_id) values (2, '2019-04-04T05:30', '3C', 800, 0, 'Mara', 'Maric', 'url', 'true',0, 'false', 'true','false',20);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (4, '2019-06-05T06:50', '2B', 1500, 20, 'Kata', 'Katic', 'ocno', 'true',0, 'false', 'true','false',22);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz,poslatnaobradu,korisnik_id) values (2, '2019-11-04T04:10', '3C', 1800, 0, 'Mara', 'Maric', 'url', 'true',0, 'false', 'true','false',20);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled,prikaz,poslatnaobradu,korisnik_id) values (6, '2019-12-05T06:15', '2B', 900, 10, 'Pedja', 'Matic', 'dermatologija', 'true',0, 'false', 'true','false',24);
insert into termini(lekar_id, termin,sala, cena, popust,lekarime, lekarprezime,tippregleda,zakazan,idkorisnika,odobrenpregled, prikaz,poslatnaobradu,korisnik_id) values (4, '2019-11-04T05:30', '3C', 1800, 0, 'Kata', 'Katic', 'ocno', 'true',0, 'false', 'true','false',22);
...
insert into korisnik3 ( ime,prezime, username,password, email,adresa, grad, drzava,  jed_br_osig, telefon,active,role ,login,klinika_id ) values ('Mara', 'Maric','mara1962','mara1962','mara1962@gmail.com','Ustanicka 52','Novi Sad','Srbija','0202962123456','06478596513','TRUE','LEKAR',true,6 );
insert into korisnik3 (ime,prezime, username,password, email,adresa, grad, drzava,  jed_br_osig, telefon,active,role ,login,klinika_id) values ('Sara', 'Saric','sara1963','sara1963','sara1963@gmail.com','Ustanicka 53','Novi Sad','Srbija','0202963123456','06478596514','TRUE','LEKAR',true,1 );
insert into korisnik3 ( ime,prezime, username,password, email,adresa, grad, drzava,  jed_br_osig, telefon,active,role ,login,klinika_id ) values ('Kata', 'Katic','kata1964','kata1964','kata1964@gmail.com','Ustanicka 54','Novi Sad','Srbija','0202964123456','06478596515','TRUE','LEKAR',true,4 );
insert into korisnik3 ( ime,prezime, username,password, email,adresa, grad, drzava,  jed_br_osig, telefon,active,role ,login,klinika_id) values ('Mira', 'Mitrovic','mira1965','mira1965','mira1965@gmail.com','Ustanicka 55','Novi Sad','Srbija','0202965123456','06478596516','TRUE','LEKAR',true,7 );
insert into korisnik3 (ime,prezime, username,password, email,adresa, grad, drzava,  jed_br_osig, telefon,active,role ,login,klinika_id) values ( 'Pedja', 'Matic','pedja1966','pedja1966','pedja1966@gmail.com','Ustanicka 56','Novi Sad','Srbija','0202966123456','06478596517','TRUE','LEKAR',true,2 );
